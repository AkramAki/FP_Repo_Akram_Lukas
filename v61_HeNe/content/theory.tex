...
After polarized light is transmitted through a polarization filter, the light is linearly polarized along the polarization axis of the filter while its intensity is reduced 
according to Malus' law
\begin{equation*}
    I=I_0\cos^2(\theta)\,,
\end{equation*}
with the initial intensity $I_0$ and $\theta$ as the angle between polarization axis of light and filter.  
