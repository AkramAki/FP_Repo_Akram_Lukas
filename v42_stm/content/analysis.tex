...
\begin{figure}
   ...
   \caption{Forward measurement of the gold sample.}
...
\begin{table}
   ...
   \begin{tblr}{
    ...
    \toprule 
        \text{Profile} & d \mathbin{/} \unit{\nano\meter} \\
    \midrule
        \text{Forwards scan 1} & 1 \\
        \text{Forwards scan 2} & 1 \\
        \text{Forwards scan 3} & 1 \\
        \text{Backwards scan 1} & 1 \\
        \text{Backwards scan 2} & 1 \\
        \text{Backwards scan 3} & 1 \\
    \bottomrule
   \end{tblr}
\end{table}
