...
The solid angle $\Omega$ subtended by the detector is calculated from the detector geometry using the expression given in the theory section. For a detector radius
\[
  r = \qty{2.25}{\centi\meter}
\]
and a source-to-detector distance
\[
  a = \qty{9.5}{\centi\meter},
\]
the solid angle is
\[
  \Omega = 0.169.
